# Generated by Django 4.2.1 on 2023-07-18 05:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vmIdPK', models.AutoField(default='', primary_key=True, serialize=False)),
            ],
            options={
                'db_table': 'VmResource',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sourceId', models.CharField(default='', max_length=100, null=True)),
                ('history', models.TextField(default='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_start_date', models.DateField(null=True)),
                ('eRole', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='emp_data.role')),
                ('refer_Customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='emp_data.customer')),
            ],
            options={
                'db_table': 'employee',
            },
