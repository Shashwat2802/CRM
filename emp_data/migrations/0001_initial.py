    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customers', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='emp_data.customer')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vmIdPK', models.AutoField(default=0, primary_key=True, serialize=False)),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='emp_data.employee')),
            ],
            options={
                'db_table': 'VmResource',
            },
        ...
        migrations.CreateModel(
            name='TA_Resource',
            fields=[
                ('ta_id', models.CharField(max_length=10, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(default='LEADSOC', max_length=100, null=True)),
                ...
                ('history', models.TextField(default='')),
                ('req_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='emp_data.customer_requirements')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='employee',
            name='eRole',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='emp_data.role'),
        ),
        migrations.AddField(
            model_name='employee',
            name='refer_Customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='emp_data.customer'),
        ),
    ]
