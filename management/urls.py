...
urlpatterns = [   
    ...
    path('edit_user_permissions/<str:user_id>/', views.edit_user_permissions, name='edit_user_permissions'),
   ...
   # customer requirements details
    path('listSalesReqsFiltered/<str:bu>/<str:sales>/<str:st>/<str:priority>/<str:fillThru>',views.listSalesReqsFiltered),
